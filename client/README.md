1]
we used two seprate dockerfile for 
the devlopment and the production
...
For devlopment we use 
   @ Dockerfile.dev
 start up command
   $ npm run dev

2] when we get error related to websocket in browser console then we edit the default.conf file present in the nginx folder and we added the code.
 ...
 location /sockjs-node {
    ...
    After adding this code the wesocket error is gone and it enable autoreload 
